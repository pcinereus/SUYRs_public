...
![Six-plated barnacle](../public/resources/barnacles.jpg){#fig-barnacle width="224" height="308"}
...
## Skim (modelsummary)
```{r}
day |> modelsummary::datasummary_skim(categorical = TRUE)
```
...
ggpredict(day.rstanarm2) |>
  plot(show_data=TRUE, log.y = TRUE)
```
