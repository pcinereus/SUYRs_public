...
```{r fitModel1, results='markdown', eval=TRUE, hidden=TRUE, cache=TRUE}
set.seed(123)
...
```{r fitModel2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
(best.iter = gbm.perf(leathwick.gbm,method='OOB'))
(best.iter = gbm.perf(leathwick.gbm,method='cv'))
```

```{r fitModel3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width=10, fig.height=10}
...
```{r partialPlots1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width=10, fig.height=10}
leathwick.gbm %>%
...
```{r Accuracy1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width=10, fig.height=10}
leathwick_test %>%
