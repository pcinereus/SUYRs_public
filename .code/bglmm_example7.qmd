...
mullens.brm2 |> ggpredict(~O2LEVEL|BREATH) |> plot(add.data = TRUE, jitter =  FALSE)
...
mullens.brm2 |> pp_check(group="BREATH", type='intervals_grouped') 
mullens.brm2 |> pp_check(group="O2LEVEL", type='intervals_grouped') 
```
...
mullens.brm2 |> ggemmeans(~O2LEVEL|BREATH) |> plot(add.data = TRUE, jitter =  FALSE)
```
::::
:::
<!-- END_PRIVATE-->
