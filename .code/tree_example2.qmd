...
```{r partialPlots2, results='markdown', eval=TRUE, cache=TRUE, fig.width=10, fig.height=10}
...
```{r partialPlots3, results='markdown', eval=TRUE, cache=TRUE, fig.width=10, fig.height=10}
